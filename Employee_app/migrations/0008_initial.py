...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('Employee_app', '0007_delete_batches_remove_branch_district_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cource_name', models.CharField(max_length=255, verbose_name='Cource:')),
                ('cource_code', models.CharField(max_length=20, verbose_name='Cource Code:')),
                ('trainers', models.ManyToManyField(blank=True, limit_choices_to={'groups__name': 'Faculty', 'is_active': True}, related_name='trainer', to=settings.AUTH_USER_MODEL)),
            ],
            options={
